...
export default function QuotationPreview({ data, onBack }) {
  ...
  const generatePDF = async () => {
    ...
    doc.setFontSize(10)
    doc.text('Call Us On +91 1234567890 |   www.xyz.com', pageWidth / 2, pageHeight - 7, { align: 'center' })
    ...
    doc.text('Ph: 1234567890', pageWidth - margin - 2, 15, { align: 'right' })
    doc.text('Email: xyz@gmail.com', pageWidth - margin - 2, 20, { align: 'right' })
    doc.text('Regd Address: Plot No 001, xyz, 000012', pageWidth - margin - 2, 25, { align: 'right' })
    ...
    doc.setTextColor(0, 0, 0)
    doc.setFont('helvetica', 'bold')
    doc.text('xyz', margin, contactY)
    doc.setFont('helvetica', 'normal')
    doc.text(' xyz, 000012 India', margin, contactY + 8)
    doc.text('Contact Us: 91+ 1234567890', margin, contactY + 16)
    doc.text('Mail: xyz@gmail.com', margin, contactY + 24)
    doc.text('Website: www.xyz.com', margin, contactY + 32)
