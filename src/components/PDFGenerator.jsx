...
const PDFGenerator = ({ formData }) => {
  const generatePDF = () => {
    ...
    doc.text('OmSolar', pageWidth / 2, 40, { align: 'center' });
    
    doc.setFontSize(16);
    doc.setTextColor(0, 0, 0);
    doc.text('Thank you for choosing OmSolar!', pageWidth / 2, 60, { align: 'center' });
    ...
    doc.addPage();
    doc.setFontSize(20);
    doc.text('About OmSolar', 20, 20);
    
    const aboutContent = [
      'Company Overview',
      'Vision & Mission',
      'Contact Information',
      'Website: www.omsolar.com',
      'WhatsApp: +91 9481721501'
    ];
    ...
    doc.save('XYZ_Solar_Quotation.pdf');
  };
