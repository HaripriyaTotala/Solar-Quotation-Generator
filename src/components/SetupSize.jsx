...
const SetupSize = ({ formData, setFormData }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-4 text-gray-800 font-playfair">Setup Size Configuration</h2>
      <div className="space-y-6">
        <div>
          <label htmlFor="setupSize" className="block text-sm font-medium text-gray-700 font-playfair">
            Setup Size (kWp)
          </label>
          <input
            type="number"
