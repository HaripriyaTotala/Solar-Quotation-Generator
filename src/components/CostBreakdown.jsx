...
const CostBreakdown = ({ formData, setFormData }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-4 text-gray-800 font-playfair">Cost Breakdown</h2>
      <div className="space-y-4">
        <div>
          <label htmlFor="structureCost" className="block text-sm font-medium text-gray-700 font-playfair">
            Structure Cost (₹)
          </label>
          <input
            type="number"
        ...
        <div>
          <label htmlFor="wireCost" className="block text-sm font-medium text-gray-700 font-playfair">
            Wire Cost (₹)
          </label>
          <input
            type="number"
        ...
        <div>
          <label htmlFor="otherCosts" className="block text-sm font-medium text-gray-700 font-playfair">
            Other Costs (₹)
          </label>
          <input
            type="number"
        ...
        <div>
          <label htmlFor="gstPercentage" className="block text-sm font-medium text-gray-700 font-playfair">
            GST Percentage (%)
          </label>
          <input
            type="number"
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-md">
          <h3 className="text-lg font-medium text-gray-700 mb-3 font-playfair">Cost Summary</h3>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-600 font-playfair">Total Base Cost:</span>
              <span className="font-semibold">₹{calculateTotalBaseCost().toLocaleString()}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 font-playfair">GST Amount:</span>
              <span className="font-semibold">₹{calculateGSTAmount().toLocaleString()}</span>
            </div>
            <div className="flex justify-between pt-2 border-t border-gray-200">
              <span className="text-gray-800 font-medium font-playfair">Total Cost (Including GST):</span>
